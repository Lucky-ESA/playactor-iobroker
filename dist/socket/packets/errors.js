...
exports.resultToErrorCode = exports.resultsToErrorCodes = void 0;
exports.resultsToErrorCodes = {
    0: "OK",
    1: "BUSY",
...
function resultToErrorCode(result) {
    var _a;
    if (result === 0)
        return;
    return (_a = exports.resultsToErrorCodes[result]) !== null && _a !== void 0 ? _a : "UNKNOWN_ERROR";
}
exports.resultToErrorCode = resultToErrorCode;
